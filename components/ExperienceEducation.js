export default function ExperienceEducation() {
  return (
    <div
      ...
      className="bg-gradient-to-b from-[#ffdd57] to-white text-gray-900 p-8 md:p-16 grid gap-10 rounded-xl shadow-lg mx-auto max-w-7x5" // Mengubah lebar maksimum dan padding
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        >
          <h2 className="text-2xl md:text-3xl font-semibold mb-6 text-gray-900">Experience</h2>
        ...
        <div
          ...
          className="p-8 bg-white rounded-lg shadow-md border border-gray-300 transform transition-transform duration-300 ease-in-out hover:scale-105 cursor-pointer" // Animasi zoom saat diklik
        >
          <h2 className="text-2xl md:text-3xl font-semibold mb-6 text-gray-900">Education</h2>
          <ul className="space-y-6">
            <li>
              <div className="flex flex-col md:flex-row justify-between">
